...
<figure>
	{% img image, 'io in panciolle davanti alla chiesa parrocchiale di San Faüstin e Santa Giovita' %}
...
<figure>
	{% img '/aigovo-sign.webp', 'un cartello che mostra la direzione per Aigovo' %}
</figure>
...
{% img '/aigovo-scale-tommi.webp', 'posa fiera in fondo alle scale di casa' %}
...
<figure>
	{% img '/aigovo-elder-walk.webp', 'simpatica signora di ritorno a casa al tramonto' %}
...
<figure>
	{% img '/aigovo-crocefisso.webp', 'un crocefisso di fronte al bosco' %}
