---
title: De Explosiva mente
date: 2020-05-12
aliases: Genesi di xplosionmind
tags: geek
image: /assets/2020-05-12-genesi.jpg
permalink: /genesi/
redirect_from: [/de-explosiva-mente/]
ref: genesi
description: La narrazione della genesi di questo sito web
---
Ho sempre amato i semplici ma contemporaneamente maestosi titoli latini in “de + ablativo” e non ho saputo resistere nel trovare il coraggio di distruggere grandi opere del livello del <cite>De bello gallico</cite> e <cite>De agricoltura</cite> intitolando così questo articolo. Allo stesso tempo, come <cite>Candido o l’Ottimismo</cite>, volevo mettere “o”. Mi sono tolto una soddisfazione.
...
Esisteva [una versione precedente del sito](https://web.archive.org/https://xplosionmind.wixsite.com/xplosionmind), che ho creato utilizzando [Wix](https://wix.com), in cui prendevo le figurine belle che mi piacevano, le trascinavo con il mouse ed era fatta.
...
- è così bello pensare all’inimitabile splendida *potente* Uma Thurman ogni volta che si apre una pagina nuova. **<cite>Kill Bill</cite>**. Giallo e nero sono i colori di <cite>Kill Bill</cite> (e grazie mille alla mia gemella di entusiasmo Anna Maria di Matera che me lo ha fatto notare);
- l’Ape Maya. <i lang='fr'>Ça va sans dir</i>.
- Essendo colori di cantiere, non posso non ammettere che di mezzo ci sono anche i miei grandiosi pazzeschi potentissimi amici, i [Cantiere 164](https://youtube-nocookie.com/embed/hu8IPqi6_ak).

Ci sono degli accenni di blu, soprattutto ne <cite>[La Marmellata](/marmellata')</cite>>. Motivi: uno il mare, due la marmellata di mirtilli. Eh.
...
1. Metterle comunque, a costo di rabbrividire ogni volta che avrei aperto lo <cite>[Zibaldone](/zibaldone)</cite>
...
3. Utilizzare colori di sfondo lievemente differenti che si alternano, un po’ come ho fatto in [tutto](/tutto), solamente che non sapevo come impostare uno sfondo diverso solo per le iterazioni dispari in un for loop su Liquid (sto già diventando troppo tecnico. In sintesi: non ero capace).
...
<figure>
	<img src='{{ image }}' alt='Un disegno della pagina iniziale del sito come cantiere' class='u-photo'>
	<figcaption>Il cantiere di <i>xplosionmind</i></figcaption>
</figure>

## Tipografia

Ora devo trattenermi. Da quando il mitico prof. Ciulla mi prestò <cite>[Il canone Vignelli](https://openlibrary.org/works/OL16963936W/The_Vignelli_Canon)</cite> in quarta superiore, io sono fissato, innamorato perso della tipografia. Mi fa impazzire. Se potesse diventare una ragazza, io sposerei un font (a quale sposerei ci arriviamo). Qualcosa di incredibile, stratosferico, commovente, ma allo stesso tempo dal fine di utilizzo estremamente pratico e concreto. Vediamo, leggiamo scritte tutti i giorni e non pensiamo alle ore, agli anni di studio che una mente geniale ha trascorso per accostare in modo perfetto quelle forme geometriche, o di come nei secoli queste si siano strette, allargate, assottigliate, capovolte, complicate, raddrizzate. Appena avrò studiato l’argomento più approfonditamente dedicherò assolutamente un pensiero dello _Zibaldone_ alla tipografia, per ora c’è solo [un ingrediente](../jam/public/Typography.md) de <cite>[La Marmellata](../jam.liquid)</cite> al riguardo.

Dato che sono un <em lang='en'>typography enthusiast</em>, sin dalla prima stringa di CSS che ho scritto ero consapevole e sicuro che la scelta del font sarebbe stata cruciale, vitale, decisiva nella costruzione di xplosionmind. Il font, ovunque, è [Inter](https://rsms.me/inter). Quasi uno scherzo del destino che il font che ho scelto si chiami come una squadra di calcio, favoloso. Tutto torna.

In realtà, se io potessi, userei sempre, unicamente, incondizionatamente [Helvetica](https://it.wikipedia.org/wiki/Helvetica 'Helvetica su Wikipedia'). È lui, il font che sposerei. _Helvetica_. Però, porca puzzola, come tutte le Beatrici che si rispettino, Helvetica è una bellezza inaccessibile, e il nostro un amore impossibile. Helvetica può essere utilizzata (quando si parla di un font, si sottintende sempre la parola 'font', quindi tutti i font, teoricamente sono al maschile, ma lei… lei no.) solo per uso personale. È disponibile fra i font preinstallati su Mac e Windows, ma se si intende creare qualcosa sul cui design poi si metterà la firma (come questo sito, che è pubblicato con la licenza [Creative Commons Share alike blabla](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.it 'Attribuzione - Non commerciale - Condividi allo stesso modo 4.0 Internazionale'), presente nel footer di ogni pagina) non la puoi utilizzare. Perciò, a malincuore, ho dovuto cercare un’alternativa. Per fortuna, non è stato difficile, anzi, molto facile: quello con Inter è stato un colpo di fulmine. le sue o, le sue e, aaah, le sue elle. Una magia. il papà di Inter è un designer troppo figo che si chiama [Rasmus Andersson](https://rsms.me) e che nel tempo libero [guida macchine da corsa](https://rsms.me/about). Ho deciso immediatamente. Inter sarebbe stato il font di xplosionmind.

Per quanto riguarda il font serif (cioè con tutti i fronzoli: quello che uso negli articoli e nelle poesie) sarò più breve: è un font aperto, libero, sviluppato da [GUST e-foundry](http://www.gust.org.pl/projects/e-foundry), un team di tipografi polacchi. Mi è stato simpatico da subito, è meno aggressivo e presuntuoso di [Playfair Display](https://github.com/clauseggers/Playfair-Display) (che ho utilizzato sul sito precedente), ho scelto di adottarlo con leggerezza e fiducia, sono soddisfatto.
...
Sono (purtroppo ero, non lo sono più come una volta) appassionato all’astronomia e a tutte le figate legate all’esplorazione spaziale. per questo, alle superiori passavo ore dei miei pomeriggi di pseudo-studio a guardare le live streaming di [SpaceX](https://www.spacex.com/) (quella di Elon Musk) che mostravano il lancio delle navicelle <cite lang='en'>[Dragon](https://www.spacex.com/vehicles/dragon)</cite>, contenenti i rifornimenti per la <abbr title='International Space Station'><a href='https://www.esa.int/Science_Exploration/Human_and_Robotic_Exploration/International_Space_Station' hreflang='en'>ISS</a></abbr>. Essendo senza pilota, le navicelle Dragon, una volta nell’orbita della ISS, non possono attaccarsi da sole alla stazione, ma devono essere “catturate” da un braccio robotico fighissimo chiamato <cite><a href='https://asc-csa.gc.ca/eng/canadarm/default.asp' hreflang='en'>Canadarm</a></cite>. Quando un astronauta assume il controllo del Canadarm per afferrare un Dragon, ha un’interfaccia simile a quella del mirino di un cecchino, con `+` al centro.
...
Ne stavo per uscire pazzo: la prima cosa che farò ora è disintossicarmi dal codice. Starò per un po’ a leggere e scrivere, guardare, approfondire e scoprire come sempre, ma stando alla larga da [Vim](https://www.vim.org).

Appena avrò trovato un equilibrio fra [umanità e tecnica](/filinge/), riprenderò a sviluppare i dettagli mancanti. Ciò che ho in programma di aggiungere o sistemare è [qui]({{ site.issues }} 'xplosionmind issues'), dove potete [aprire un issue]({{ site.issues }}/new 'Aprire un nuovo issue nella repository di questo sito'). Se avete difficoltà a leggere testo bianco su sfondo nero, ho intenzione di aggiungere un pulsante che cambia sfondo da chiaro a scuro. Se per voi leggere in questo modo è un problema, segnalatemelo, csì valuto quanta priorità dare all’implementazione di questa funzionalità.

Grazie, grazie, grazie. A tutti gli amici che mi hanno sopportato mentre ero in palla perché impazzivo a programmare il sito, a tutti i santi che hanno accettato di testarlo in anteprima e, per ultimo ma non ultimo, il mitico [Claudio Faoro](https://claudiofaoro.com 'Sito personale di Claudio'), che mi ha dato una mano e molti consigli sullo sviluppo.
