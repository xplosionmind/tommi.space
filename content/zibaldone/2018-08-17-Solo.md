...
<figure>
	{% comment %}{% img image, 'io in panciolle davanti alla chiesa parrocchiale di San Faüstin e Santa Giovita' %}{% endcomment %}
...
<figure>
	{% comment %}{% img '/aigovo-sign.webp', 'un cartello che mostra la direzione per Aigovo' %}{% endcomment %}
</figure>
...
{% comment %}{% img '/aigovo-scale-tommi.webp', 'posa fiera in fondo alle scale di casa' %}{% endcomment %}
...
<figure>
	{% comment %}{% img '/aigovo-elder-walk.webp', 'simpatica signora di ritorno a casa al tramonto' %}{% endcomment %}
...
<figure>
	{% comment %}{% img '/aigovo-crocefisso.webp', 'un crocefisso di fronte al bosco' %}{% endcomment %}
