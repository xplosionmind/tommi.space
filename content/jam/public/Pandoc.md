...
Replace `commonmark` with `commonmark_x` to have more features. See the [list of supported markdown variants](https://pandoc.org/MANUAL.html#markdown-variants 'Markdown variants — Pandoc User’s Guide').
